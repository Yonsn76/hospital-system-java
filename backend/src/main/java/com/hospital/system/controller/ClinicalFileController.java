...
import com.hospital.system.dto.FileAccessLogResponse;
import com.hospital.system.model.AccessAction;
import com.hospital.system.model.FileType;
import com.hospital.system.service.ClinicalFileService;
import com.hospital.system.service.FileAccessLogService;
...
public class ClinicalFileController {
    ...
    public ResponseEntity<List<FileAccessLogResponse>> getFileAccessLogs(@PathVariable Long id) {
