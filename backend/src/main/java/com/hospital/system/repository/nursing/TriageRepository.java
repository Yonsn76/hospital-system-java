...
import com.hospital.system.model.nursing.Triage;
...
public interface TriageRepository extends JpaRepository<Triage, Long> {
    ...
    @Query("SELECT t FROM Triage t WHERE t.status = 'WAITING' ORDER BY " +
           ...
           "WHEN com.hospital.system.model.nursing.TriagePriority.RESUSCITATION THEN 1 " +
           "WHEN com.hospital.system.model.nursing.TriagePriority.EMERGENT THEN 2 " +
           "WHEN com.hospital.system.model.nursing.TriagePriority.URGENT THEN 3 " +
           "WHEN com.hospital.system.model.nursing.TriagePriority.LESS_URGENT THEN 4 " +
           "WHEN com.hospital.system.model.nursing.TriagePriority.NON_URGENT THEN 5 " +
