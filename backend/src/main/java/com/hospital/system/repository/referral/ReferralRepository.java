package com.hospital.system.repository.referral;

import com.hospital.system.model.referral.Referral;
import com.hospital.system.model.referral.ReferralStatus;
import com.hospital.system.model.referral.ReferralUrgency;
...
public interface ReferralRepository extends JpaRepository<Referral, Long> {
    ...
    @Query("SELECT r FROM Referral r WHERE r.destinationDoctorId = :doctorId AND r.status = 'PENDING' " +
           ...
           "WHEN com.hospital.system.model.referral.ReferralUrgency.URGENT THEN 1 " +
           "WHEN com.hospital.system.model.referral.ReferralUrgency.PRIORITY THEN 2 " +
           "WHEN com.hospital.system.model.referral.ReferralUrgency.ROUTINE THEN 3 " +
