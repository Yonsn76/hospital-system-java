...
public class ClinicalHistoryService {
    ...
    private AllergyResponse mapToAllergyResponse(com.hospital.system.model.Allergy allergy) {
    ...
    private ChronicDiseaseResponse mapToChronicDiseaseResponse(com.hospital.system.model.ChronicDisease disease) {
    ...
    private ClinicalEvolutionResponse mapToEvolutionResponse(com.hospital.system.model.ClinicalEvolution evolution) {
    ...
    private PatientResponse mapToPatientResponse(com.hospital.system.model.Patient patient) {
